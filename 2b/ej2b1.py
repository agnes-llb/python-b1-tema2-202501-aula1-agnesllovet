...
Las buenas practicas de programación de Python PEP8 las puedes encontrar en 
el siguiente enlace:
...
funcio 'sum_list_numbers', el paràmetre ha de ser nomenat correctament i 
